...
theme_scilicium <- function() {
  ...
  ggplot2::theme_minimal() +
    ...
    ggplot2::theme(plot.title = ggplot2::element_text(colour = scilicium_params$title_colour, family=scilicium_params$title_family)) +
    ggplot2::theme(plot.subtitle = ggplot2::element_text(colour = scilicium_params$subtitle_colour, family=scilicium_params$subtitle_family)) +
    ...
    ggplot2::theme(axis.line.x = ggplot2::element_line(color=scilicium_params$text_colour),
          axis.line.y = ggplot2::element_line(color=scilicium_params$text_colour)) +
